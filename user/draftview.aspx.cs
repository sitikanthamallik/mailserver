...
public partial class user_draftview : System.Web.UI.Page
{
    ...
    public void disp()
    {
        ...
        object[] valu = { "getdraftdetails", Session["userid"] };
        ob.RetiveDS(parm, valu, "draftproc");
    ...
    protected void Subject_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("draftdetails.aspx?id=" + hid.Value);
    }
