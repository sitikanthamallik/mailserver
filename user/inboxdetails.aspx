<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/user/MasterPage.master" CodeFile="inboxdetails.aspx.cs" Inherits="user_inboxdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <table style="width:100%;">
            <tr>
                <td colspan="2" style="background-color: #99CCFF; font-weight: bold; color: #FF0000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; INBOX DETAILS</td>
            </tr>
            <tr>
                <td class="auto-style4" style="background-color: #CCFFFF; color: #0066FF;">Send From</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Back to Inbox</asp:LinkButton>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style7" style="color: #0066FF; background-color: #CCFFFF">
                    <asp:Label ID="lblattachfile" runat="server" Text="Attach File" Visible="False"></asp:Label>
                </td>
                <td style="background-color: #CCFFFF" class="auto-style8">
...
&nbsp;&nbsp;
                    <asp:Label ID="lblforwardbody" runat="server"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" Visible="False">Back to inbox</asp:LinkButton>
                </td>
            </tr>
        </table>
</asp:Content>
